...
//    private static JPanel pokemonPanel; // Panel para mostrar los Pokémon
...
//                            pokemonRepository.save(pokemon);updatePokemonCard(pokemon);
//                            JOptionPane.showMessageDialog(frame, pokemonName + " se ha encontrado!");
//                        } else {
...
//
//    // actualizar cartas
//    private static void updatePokemonCard(Pokemon pokemon) {
//        executorService.submit(() -> {
...
//
//    // crear cartas
//    private static JPanel createPokemonCard(Pokemon pokemon, boolean isCaptured) {
...
//
//        // Nombre del Pokémon
//        JLabel nameLabel = new JLabel(pokemon.getId() +" "+ pokemon.getName());
...
//
//        for(PokemonType type : tipos) {
//            typeLabel = new JLabel(type.getName());
